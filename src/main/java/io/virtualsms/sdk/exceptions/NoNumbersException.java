 ...
 */
public class NoNumbersException extends ServerErrorException {

    public NoNumbersException(String message, boolean mutatingRequest) {
        super(message, mutatingRequest);
    }
}
